...
const Hero = () => {
  return (
    <div  className=" relative h-screen overflow-hidden bg-herobg bg-cover bg-center" style={{ height: '532px' }}>
    <div className=" text-center text-black">
      ...
      <div className="flex justify-center pt-10" style={{ opacity: 1, transform: 'none' }}>
        <a className="group flex gap-2 rounded-lg bg-translucent-dark-300 px-8 py-3 transition-all duration-500 hover:bg-secondary-300" aria-label="go to about page" href="/about">
          Learn More
