...
const ProductExplorer = () => {
  ...
  return (
    <div className="relative w-full bg-products-bg bg-left-bottom bg-no-repeat bg-cover" style={{ backgroundImage: 'url(/products_bg(1).svg)' }}>
                ...
                >
                  <button
                    ...
                    className={`inline-flex items-center justify-center whitespace-nowrap px-3 py-1 text-sm font-medium ring-offset-background focus-visible:outline-none rounded-3xl ${
                      activeTab === 0 ? 'bg-background text-foreground shadow border-primary border' : 'transition-all'
                    } hover:bg-ui-200`}
                  ...
                  <button
                    ...
                    className={`inline-flex items-center justify-center whitespace-nowrap px-3 py-1 text-sm font-medium ring-offset-background focus-visible:outline-none rounded-3xl ${
                      activeTab === 1 ? 'bg-background text-foreground shadow border-primary border' : 'transition-all'
                    } hover:bg-ui-200`}
                    ...
                    <div className="rounded-xl border bg-card text-card-foreground shadow my-4 grid md:grid-cols-2">
                      <div className="relative flex items-center justify-center rounded-xl bg-gradient-to-r from-green-400 to-green-100 pb-10 lg:rounded-r-none">
                        <div className="relative overflow-hidden">
                          <img className={`w-[250px] p-8 ${activeTab === 0 ? 'slide-enter-right' : 'hidden'}`} src={sliderImages[0]} alt="Slide 1" />
                          <img className={`w-[250px] p-8 ${activeTab === 1 ? 'slide-enter-right' : 'hidden'}`} src={sliderImages[1]} alt="Slide 2" />
                        </div>
